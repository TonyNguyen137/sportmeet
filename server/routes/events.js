...
export const createEventsRouter = (
	...
	router.get(
		...
		handlers.checkAuth,
		handlers.getEventParticipantsList
	);
	...
	router.post(
		...
		handlers.checkAuth,
		handlers.formParser,
		handlers.createEventComment
	);
	router.post(
		'/:eventId/comments/:commentId/delete',
		handlers.checkAuth,
		handlers.removeEventComment
	);
	router.delete(
	...
	router.post(
		...
		handlers.checkAuth,
		handlers.removeEventParticipant
	);
	router.delete(
